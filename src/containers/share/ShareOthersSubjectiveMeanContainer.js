...
import VocabStudySubjectiveMean from '../../components/vocab/VocabStudySubjectiveMean';
...
const ShareOthersSubjectiveMeanContainer = ({ history, match }) => {
...
export default withRouter(ShareOthersSubjectiveMeanContainer);
